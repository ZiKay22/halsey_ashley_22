        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="d-flex justify-content-between">
                <a class=" text-white btn btn-outline-light bg-dark" aria-current="page" href="s_d.php">Download Songs</a>
                <a class="mx-2 text-white btn btn-outline-light bg-dark" aria-current="page" href="s_txt.php">Song's text</a>
                <a class=" text-white btn btn-outline-light bg-dark" aria-current="page" href="s_txt_tr.php">Song's translate</a>
              </div>
