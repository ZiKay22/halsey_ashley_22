                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                          <li><a class="dropdown-item  text-whitr" href="s_d.php">Songs Dowload</a></li>
                    ...
                    <div class="accordion-body">
                      <div class="row">
                        <div class="col-12 col-md-4">
                          <div id="list-example " class="list-group bg-dark ">
                            <a class="list-group-item list-group-item-action bg-dark text-light border border-secondary" href="#list-item-1">2012–2014: Career beginnings</a>
                            <a class="list-group-item list-group-item-action bg-dark text-light border border-secondary" href="#list-item-2">2014–2016: Badlands and breakthrough</a>
                            <a class="list-group-item list-group-item-action bg-dark text-light border border-secondary" href="#list-item-3">2017–2018: Hopeless Fountain Kingdom</a>
                            <a class="list-group-item list-group-item-action bg-dark text-light border border-secondary" href="#list-item-4">2018–2021: Manic and If I Can't Have Love, I Want Power</a>
                            <a class="list-group-item list-group-item-action bg-dark text-light border border-secondary" href="#list-item-5">2022–present: "So Good" release controversy</a>
                          </div>
                        ...
                        <div class="col-12 col-md-8">
                          <div class="bg-dark"data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
